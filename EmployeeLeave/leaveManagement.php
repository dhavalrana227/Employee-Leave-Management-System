...
<body>
            ...
            <main class="content">
                ...
                <div class="container-fluid" id="productsEmptyPage" style="display: none;">
                    <center>
                        ...
                        <h3 class="mt-5">You don't have any leave that you can Approved/Not Approved !</h3>
                    </center>
                </div>
            <div class="container-fluid pt-1 ps-5 pe-5 ms-4" id="productsPage">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Leaves</strong>&nbsp Approved/Not Approved</h3>
    ...
    <script>
        ...
        function fetchOrders() {
            ...
            XRH.open('GET', './php/getLeaveManage.php');
            XRH.onload = function () {
                ...
                for (let leave of obj) {
                    ...
                    tableData += '<tr><td>' + leave.PostingDate + '</td><td> ' + leave.LeaveType + '</td><td>' + ssts + '</td><td><p>' + leave.e_name + '</p></td><td><button class="btn btn-outline-success myBtn" data-bs-toggle="modal"><a href="viewDetailsAction.php?leaveID='+leave.leaveID+'&PostingDate='+leave.PostingDate+'" style="text-decoration:none">View Details</a></button></td></tr>';
                }
